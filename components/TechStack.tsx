  ...
  return (
    <>
      <style>{`
        ...
        .tech-item.devtool:hover {
          background: rgba(191,0,255,0.05);
          border-color: rgba(191,0,255,0.2);
          box-shadow: 0 8px 24px rgba(191,0,255,0.06);
        }
        .tech-item img {
          width: 40px;
          height: 40px;
      ...
      <section id="tech-stack" className="py-32 px-6" style={{ maxWidth: '1152px', margin: '0 auto', marginBottom: '120px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <div style={{
            ...
            borderRadius: '16px',
            padding: '36px',
            boxShadow: '0 0 40px rgba(0,245,255,0.03)',
          }}>
            <p style={{ fontFamily: 'monospace', fontSize: '10px', letterSpacing: '0.3em', textTransform: 'uppercase', color: '#00f5ff', marginBottom: '24px' }}>
              ...
              {techStack.map(tech => (
                <div key={tech.id} className="tech-item">
                  {tech.icon_url ? (
                    ...
                    <div style={{ width: '40px', height: '40px', borderRadius: '8px', border: '1px solid rgba(0,245,255,0.2)', opacity: 0.3 }} />
                  )}
                  <span>{tech.name}</span>
                </div>
              ))}
              ...
              {devTools.map(tech => (
                <div key={tech.id} className="tech-item devtool">
                  {tech.icon_url ? (
                    ...
                    <div style={{ width: '40px', height: '40px', borderRadius: '8px', border: '1px solid rgba(191,0,255,0.2)', opacity: 0.3 }} />
                  )}
                  <span>{tech.name}</span>
                </div>
              ))}
