...
const fallbackProjects: Project[] = [
  {
    ...
    description: 'Personal portfolio built with Next.js, TypeScript, and Supabase.',
    category: 'website',
    link: 'YOUR LINK HERE',
  ...
  },
  {
    ...
    description: 'A complete UI/UX design for an e-commerce platform designed in Figma.',
    category: 'figma',
    link: 'YOUR LINK HERE',
    image_url: '/PROJECT.png',
  },
  {
    ...
    description: 'Logo and brand identity design for a local business.',
    category: 'graphic',
    link: 'YOUR LINK HERE',
    image_url: '/PROJECT.png',
  },
  {
    id: '4',
    title: 'Dashboard App',
    description: 'Admin dashboard with data visualization built with React and Tailwind.',
    category: 'website',
    link: 'YOUR LINK HERE',
    image_url: '/PROJECT.png',
  },
  {
    id: '5',
    title: 'Mobile App UI',
    description: 'Mobile app UI design for a food delivery service in Figma.',
    category: 'figma',
    link: 'YOUR LINK HERE',
    image_url: '/PROJECT.png',
  },
  {
    ...
    description: 'Social media graphics and templates for a local brand.',
    category: 'graphic',
    link: 'YOUR LINK HERE',
    image_url: '/PROJECT.png',
  },
...
export default function Projects() {
  ...
  const getCtaLabel = (cat: string) => {
    if (cat === 'figma') return 'Open in Figma'
  ...
  return (
    <>
      <style>{`
        ...
        .proj-view-btn {
          font-family:monospace; font-size:10px; letter-spacing:0.2em; text-transform:uppercase;
          padding:10px 26px; border-radius:6px; border:1px solid; background:rgba(5,5,8,0.5);
          backdrop-filter:blur(4px); cursor:pointer; text-decoration:none; display:inline-block;
        ...
        .proj-badge {
          position:absolute; top:12px; left:12px; font-family:monospace; font-size:9px;
          letter-spacing:0.15em; text-transform:uppercase; padding:4px 10px; border-radius:4px;
          border:1px solid; background:rgba(5,5,8,0.85); z-index:3;
        }
        .proj-info { padding:18px 20px 20px; border-top:1px solid rgba(255,255,255,0.05); }
        .proj-info-top { display:flex; align-items:flex-start; justify-content:space-between; gap:12px; margin-bottom:8px; }
        .proj-title { font-family:'Syne',sans-serif; font-weight:700; font-size:15px; color:#fff; line-height:1.3; }
        .proj-desc {
          font-family:monospace; font-size:11px; color:#6b7280; line-height:1.65;
          display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden;
        }
        .proj-arrow {
          flex-shrink:0; width:30px; height:30px; border-radius:50%; border:1px solid;
          display:flex; align-items:center; justify-content:center;
          font-size:13px; transition:background 0.2s ease, box-shadow 0.2s ease; text-decoration:none;
        }
        ...
        .behance-portal {
          ...
          animation:portalPulse 4s ease-in-out infinite, portalFadeIn 0.5s ease both;
          text-decoration:none; display:block;
        }
        .behance-portal:hover {
          transform:translateY(-6px) scale(1.003); border-color:rgba(23,105,255,0.5); animation:none;
          box-shadow:0 0 80px rgba(23,105,255,0.2), 0 0 160px rgba(23,105,255,0.08);
        }
        .behance-grid-bg {
          position:absolute; inset:0;
          background-image: linear-gradient(rgba(23,105,255,0.05) 1px,transparent 1px), linear-gradient(90deg,rgba(23,105,255,0.05) 1px,transparent 1px);
          background-size:40px 40px; animation:gridScroll 10s linear infinite; opacity:0; transition:opacity 0.4s ease;
        }
        .behance-portal:hover .behance-grid-bg { opacity:1; }
        .behance-scanline {
          position:absolute; left:0; right:0; height:2px;
          background:linear-gradient(90deg,transparent,rgba(23,105,255,0.4),rgba(23,105,255,0.6),rgba(23,105,255,0.4),transparent);
          animation:scanline 3.5s linear infinite; pointer-events:none; z-index:2;
        }
        .behance-corner { position:absolute; width:50px; height:50px; pointer-events:none; z-index:3; opacity:0; transition:opacity 0.4s ease; }
        ...
        .behance-content {
          ...
          align-items:center; justify-content:center; padding:80px 40px; text-align:center;
        }
        .behance-wordmark {
          font-size:80px; font-weight:900; font-family:'Syne',sans-serif;
          letter-spacing:-2px; line-height:1;
          background:linear-gradient(135deg,#1769ff 0%,#4d94ff 40%,#a8d4ff 60%,#1769ff 100%);
          background-size:200% auto; -webkit-background-clip:text; -webkit-text-fill-color:transparent;
          background-clip:text; animation:shimmer 4s linear infinite; margin-bottom:14px; user-select:none;
        }
        .behance-tagline {
          font-family:monospace; font-size:11px; letter-spacing:0.3em; text-transform:uppercase;
          color:rgba(255,255,255,0.3); margin-bottom:36px; user-select:none;
        }
        .behance-cta {
          display:inline-flex; align-items:center; gap:10px; padding:14px 36px; border-radius:8px;
          border:1px solid rgba(23,105,255,0.45); background:rgba(23,105,255,0.08);
          font-family:monospace; font-size:11px; letter-spacing:0.2em; text-transform:uppercase;
          color:#6aaeff; transition:all 0.3s ease; user-select:none;
        }
        .behance-portal:hover .behance-cta {
          background:rgba(23,105,255,0.18); border-color:rgba(23,105,255,0.9);
          color:#fff; box-shadow:0 0 24px rgba(23,105,255,0.4);
        }
        .behance-arrow { display:inline-block; font-size:14px; animation:arrowBounce 1.4s ease-in-out infinite; }
        .behance-divider { width:100%; height:1px; background:rgba(255,255,255,0.05); margin-top:48px; }
        .behance-cats { display:flex; gap:0; margin-top:28px; }
        .behance-cat {
          font-family:monospace; font-size:9px; letter-spacing:0.22em; text-transform:uppercase;
          color:rgba(255,255,255,0.2); padding:0 28px;
        }
        .behance-cat:not(:last-child) { border-right:1px solid rgba(255,255,255,0.06); }
        .behance-bottom-fade {
          position:absolute; bottom:0; left:0; right:0; height:100px;
          background:linear-gradient(to top,rgba(23,105,255,0.06),transparent);
        ...
        .behance-mini {
          ...
          min-height:220px; padding:32px 24px; text-align:center; position:relative; cursor:pointer;
        }
        .behance-mini:hover { transform:translateY(-6px); border-color:rgba(23,105,255,0.45); box-shadow:0 16px 48px rgba(23,105,255,0.1); }
        .behance-mini-bg {
          position:absolute; inset:0;
          background:radial-gradient(ellipse at center,rgba(23,105,255,0.06) 0%,transparent 70%);
          pointer-events:none;
        }
        .behance-mini-title {
          font-family:'Syne',sans-serif; font-weight:900; font-size:32px; letter-spacing:-1px;
          background:linear-gradient(135deg,#1769ff,#4d94ff); -webkit-background-clip:text;
          -webkit-text-fill-color:transparent; background-clip:text; margin-bottom:8px; position:relative; z-index:1;
        }
        .behance-mini-sub {
          font-family:monospace; font-size:9px; letter-spacing:0.25em; text-transform:uppercase;
          color:rgba(255,255,255,0.25); margin-bottom:20px; position:relative; z-index:1;
        }
        .behance-mini-btn {
          display:inline-flex; align-items:center; gap:6px; padding:8px 20px; border-radius:6px;
          border:1px solid rgba(23,105,255,0.4); background:rgba(23,105,255,0.08);
          font-family:monospace; font-size:9px; letter-spacing:0.18em; text-transform:uppercase;
          color:#6aaeff; transition:all 0.3s ease; position:relative; z-index:1;
        }
        .behance-mini:hover .behance-mini-btn {
          background:rgba(23,105,255,0.18); border-color:rgba(23,105,255,0.8);
      ...
      <section id="projects" className="py-32 px-6" style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '16px' }}>
          ...
          <h2 className="section-title text-white">
            Projects<span className="neon-text-pink">.</span>
          </h2>
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginBottom: '52px' }}>
          {categories.map(cat => (
            <button
              ...
              style={{
                borderColor: filter === cat ? (categoryColors[cat] || '#00f5ff') : 'rgba(255,255,255,0.08)',
                color:       filter === cat ? (categoryColors[cat] || '#00f5ff') : '#6b7280',
                background:  filter === cat ? `${categoryColors[cat] || '#00f5ff'}14` : 'transparent',
                boxShadow:   filter === cat ? `0 0 14px ${categoryColors[cat] || '#00f5ff'}28` : 'none',
              }}
            >
              {categoryLabels[cat]}
            </button>
          ...
          <a href={BEHANCE_URL} target="_blank" rel="noopener noreferrer" className="behance-portal">
            ...
            <div className="behance-content">
              ...
              <div className="behance-cta">
                ...
                <span className="behance-arrow">↗</span>
              </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:'24px' }}>
                ...
                <div key={project.id} className={`proj-card ${project.category}`} style={{ animationDelay:`${i * 80}ms` }}>
                  <div className="proj-thumb">
                    {project.image_url ? (
                      ...
                      <div className="proj-placeholder">
                        <div style={{ width:'44px',height:'44px',border:`1px solid ${color}`,borderRadius:'8px',opacity:0.2 }} />
                      </div>
                    )}
                    <span className="proj-badge" style={{ borderColor:color, color }}>
                      {project.category === 'website' ? 'Web' : 'Figma'}
                    </span>
                    <div className="proj-thumb-overlay">
                      {href && href !== '#' && (
                        <a href={href} target="_blank" rel="noopener noreferrer"
                          className={`proj-view-btn ${project.category}`} onClick={e => e.stopPropagation()}>
                          {cta} ↗
                        </a>
                      )}
                    </div>
                  ...
                  <div className="proj-info">
                    <div className="proj-info-top">
                      ...
                      {href && href !== '#' && (
                        <a href={href} target="_blank" rel="noopener noreferrer"
                          className="proj-arrow" style={{ borderColor:color, color }} onClick={e => e.stopPropagation()}>
                          ↗
                        </a>
                      )}
                    </div>
            ...
            {showBehanceInGrid && (
              <a
                ...
                className="behance-mini" style={{ animationDelay:`${displayProjects.length * 80}ms` }}
              >
                <div className="behance-mini-bg" />
                <div className="behance-mini-title">Bē</div>
                <p className="behance-mini-sub">Graphic Design Work</p>
                <div className="behance-mini-btn">
                  View on Behance <span style={{ display:'inline-block', animation:'arrowBounce 1.4s ease-in-out infinite' }}>↗</span>
                </div>
              </a>
            )}
          </div>
